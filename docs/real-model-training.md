...
400 × 300 × 5 mm板の12クラスモデルへ2026-08-21収録分を追加した評価は、
[12クラスモデル・3セッション追加学習評価](model-training-3sessions-20260821.md)を参照してください。
次の独立600件による比較と4セッション候補は、
[12クラスモデル・4セッション学習評価](model-training-4sessions-20260821.md)に記録しています。
